...
const COUNTERS = [
  { id: 1, name: "Counter 1", color: "blue", bgColor: "bg-blue-50/50", buttonColor: "bg-blue-600", hoverColor: "hover:bg-blue-700", borderColor: "border-blue-200" },
  { id: 2, name: "Counter 2", color: "green", bgColor: "bg-green-50/50", buttonColor: "bg-green-600", hoverColor: "hover:bg-green-700", borderColor: "border-green-200" },
  { id: 3, name: "Counter 3", color: "purple", bgColor: "bg-purple-50/50", buttonColor: "bg-purple-600", hoverColor: "hover:bg-purple-700", borderColor: "border-purple-200" },
  { id: 4, name: "Counter 4", color: "orange", bgColor: "bg-orange-50/50", buttonColor: "bg-orange-600", hoverColor: "hover:bg-orange-700", borderColor: "border-orange-200" },
  { id: 5, name: "Counter 5", color: "red", bgColor: "bg-red-50/50", buttonColor: "bg-red-600", hoverColor: "hover:bg-red-700", borderColor: "border-red-200" },
]
...
export default function BillingPage() {
  ...
  const handleGenerateBill = async () => {
    ...
    try {
        // 2. Prepare Payload
        const formatPayment = (method) => method.charAt(0).toUpperCase() + method.slice(1);
        console.log("Selected Payment Method:", currentCounterData);
        const payload = {
            customer_name: currentCounterData.customerData.customerName || "Unknown",
            contact_number: currentCounterData.customerData.customerNumber,
            payment_method: formatPayment(currentCounterData.selectedPaymentMethod),
        ...
        // 4. API Call
        const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/admin/sales`, {
            method: "POST",
            headers: {
        ...
        <div className="flex flex-1 flex-col gap-6 p-6 max-w-7xl mx-auto w-full">
               ...
               {COUNTERS.map(counter => {
                  ...
                  return (
                    <button
                      ...
                      className={`
                        relative flex items-center gap-2 px-4 py-2 rounded-full border transition-all duration-200 whitespace-nowrap
                        ${isActive 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            ...
            <div className="space-y-6 lg:col-span-1">
                ...
                <Card className="shadow-lg border-0 ring-1 ring-slate-200 overflow-hidden">
                    ...
                    <CardFooter className="p-4 bg-white border-t flex flex-col gap-3">
                        ...
                        <Button variant="outline" onClick={handleClearCounter} className="w-full text-slate-500 hover:text-red-600 hover:bg-red-50 border-dashed">
            ...
            <div className="lg:col-span-2 space-y-4">
                <Card className="shadow-md border-0 ring-1 ring-slate-200 h-full min-h-[500px] flex flex-col">
