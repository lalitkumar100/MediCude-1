    ...
    <>
      <div className="flex flex-1 flex-col gap-6 p-0 max-w-7xl mx-auto w-full">
        ...
        <div className="sticky top-0 z-20 bg-white">
              ...
              <div className="col-span-1 order-3 md:order-3 md:w-48">
                <Select value={sortBy} onValueChange={setSortBy}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="mrp-asc">Low → High</SelectItem>
                    <SelectItem value="mrp-desc">High → Low</SelectItem>
                  </SelectContent>
                </Select>
              </div>
          ...
          {/* ================== TABLE HEADER ================== */}
          <div className="bg-linear-to-r from-cyan-50 to-teal-50 border-b border-cyan-200">
        ...
        {/* Pagination Footer */}
        <div className="sticky bottom-0 bg-white border-t border-gray-200 p-4 pb-1">
